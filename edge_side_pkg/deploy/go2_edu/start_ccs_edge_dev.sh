...
LAUNCH_NAMES=(go2_bridge mqtav udp_telemetry video_srt)
NODE_NAMES=(/epqrd_go2_bridge /epgeneral_mqtav /epgeneral_udp_telemetry /epgeneral_video_srt)
EXPECTED_COMMANDS=(epqrd_go2_bridge epgeneral_mqtav epgeneral_udp_telemetry epgeneral_video_srt)
