...
from ros_task_control import __version__
...
def main():
    ...
    marker = re.compile(r"<!-- ROS_TASK_CONTROL_VERSION: ([0-9]+\.[0-9]+\.[0-9]+) -->")
    ...
    if failures:
        ...
        return 1
    print("ros_task_control version %s is consistent" % manifest)
    return 0
